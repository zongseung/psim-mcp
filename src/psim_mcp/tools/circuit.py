...
def register_tools(mcp, service=None):
    ...
    @mcp.tool(
        description=(
            ...
            "폐루프 + 커스텀 컨트롤러: specs에 'closed_loop': True와 'c_code': '<C 소스>'를 함께 넣으면 "
            "PSIM SIMPLECBLOCK의 CONTENT를 LLM이 작성한 C 코드로 교체합니다 (PI/MPC/데드비트 등 자유 작성).\n"
            ...
            "    기본 타깃 SSCB7 (PI 컴펜세이터). 입력: x1=IL_ref, x2=IL_sense, x3=Kp, x4=Ti, "
            "x5=Fsamp, x6=upper_limit, x7=lower_limit, x8=ap_start. 출력: y1=duty word, y2=integ state.\n"
