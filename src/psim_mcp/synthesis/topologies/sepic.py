"""SEPIC converter synthesizer — creates CircuitGraph from requirements.

Non-isolated step-up/step-down DC-DC converter. NO position/direction/ports.
"""
...
def synthesize_sepic(requirements: dict) -> CircuitGraph:
    """Synthesize a SEPIC converter CircuitGraph from requirements."""
    ...
    nets = [
        ...
        make_net("net_cc_l2_d", ["Cc.negative", "L2.pin1", "D1.anode"], role="coupling_node"),
        make_net("net_d_out", ["D1.cathode", "Cout.positive", "Vout.pin1"], role="output_positive"),
        make_net(
            "net_gnd",
            ["V1.negative", "GND1.pin1", "SW1.source", "L2.pin2", "Cout.negative", "Vout.pin2"],
            role="ground",
        ),
    ]
    ...
    blocks = [
        ...
        make_block("coupling_capacitor", "coupling", role="coupling", component_ids=["Cc"]),
        make_block("output_filter", "filter", role="output", component_ids=["L2", "D1", "Cout", "Vout"]),
    ]

    traces = [
        make_trace("design_formula", "duty", round(duty, 6), rationale="D = Vout/(Vin+Vout)"),
        make_trace("design_formula", "l1_inductance", round(l1, 9)),
        make_trace("design_formula", "l2_inductance", round(l2, 9)),
