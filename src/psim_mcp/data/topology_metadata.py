...
TOPOLOGY_METADATA: dict[str, dict] = {
    ...
    "forward": {
        ...
        "slot_questions": {
            ...
            "switching_points": "PWM Switching_Points를 직접 지정하시겠습니까? (예: ' 0 181.')",
            "rectifier_diode_drop": "정류 다이오드 D1의 전압 강하를 몇 V로 볼까요? (예: 0.7)",
            "freewheel_diode_drop": "프리휠 다이오드 D2의 전압 강하를 몇 V로 볼까요? (예: 0.7)",
        },
