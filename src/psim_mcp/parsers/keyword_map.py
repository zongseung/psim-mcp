...
TOPOLOGY_KEYWORDS: dict[str, list[str]] = {
    ...
    "cc_cv_charger": ["\ucda9\uc804\uae30", "charger", "cc-cv", "cc cv", "\ubc30\ud130\ub9ac \ucda9\uc804", "cc/cv", "\uc815\uc804\ub958 \uc815\uc804\uc555"],
    "ev_obc": ["obc", "\uc628\ubcf4\ub4dc \ucda9\uc804", "ev \ucda9\uc804", "\uc804\uae30\ucc28 \ucda9\uc804", "on-board charger", "\uc628\ubcf4\ub4dc"],
    "lc_filter": ["lc \ud544\ud130", "lc filter"],
    "lcl_filter": ["lcl \ud544\ud130", "lcl filter"],
    "bidirectional_buck_boost": ["\uc591\ubc29\ud5a5", "bidirectional", "v2g", "v2h", "vehicle to grid", "vehicle-to-grid"],
}
...
USE_CASE_MAP: dict[str, list[str]] = {
    ...
    "laptop": ["flyback", "llc"],
    "USB": ["flyback", "buck"],
    "\uc808\uc5f0": ["flyback", "forward", "push_pull", "llc", "dab"],
    "isolated": ["flyback", "forward", "push_pull", "llc", "dab"],
    "\ube44\uc808\uc5f0": ["buck", "boost", "buck_boost", "cuk", "sepic"],
    "non-isolated": ["buck", "boost", "buck_boost", "cuk", "sepic"],
    "\ubcf4\uc870\uc804\uc6d0": ["flyback", "buck"],
    "auxiliary": ["flyback", "buck"],
    "\uac15\uc555": ["buck", "forward"],
    "\uc2b9\uc555": ["boost", "flyback"],
    "\uc591\ubc29\ud5a5": ["bidirectional_buck_boost", "dab"],
    "bidirectional": ["bidirectional_buck_boost", "dab"],
    "\uc11c\ubcf4": ["pmsm_foc_drive"],
    "servo": ["pmsm_foc_drive"],
    "\ub4dc\ub860": ["bldc_drive"],
    "drone": ["bldc_drive"],
    "UPS": ["full_bridge", "half_bridge"],
    "\uc6f0\ub529": ["full_bridge"],
    "welding": ["full_bridge"],
    "solar": ["pv_mppt_boost", "pv_grid_tied"],
    "wind": ["pmsm_foc_drive", "three_phase_inverter"],
    "\ud48d\ub825": ["pmsm_foc_drive", "three_phase_inverter"],
    "DC-DC": ["buck", "boost", "buck_boost", "flyback", "llc"],
    "DC-AC": ["half_bridge", "full_bridge", "three_phase_inverter"],
    "AC-DC": ["diode_bridge_rectifier", "boost_pfc"],
    "\ucee8\ubc84\ud130": ["buck", "boost", "flyback"],
    "converter": ["buck", "boost", "flyback"],
    "\ud544\ud130": ["lc_filter", "lcl_filter"],
    "filter": ["lc_filter", "lcl_filter"],
    "EMI": ["lc_filter"],
}
...
SLOT_QUESTIONS: dict[str, str] = {
    ...
    "fsw": "\uc2a4\uc704\uce6d \uc8fc\ud30c\uc218\ub97c \uc9c0\uc815\ud558\uc2dc\uaca0\uc5b4\uc694? (\uae30\ubcf8: 50kHz)",
    "power_rating": "\uc815\uaca9 \uc804\ub825\uc740 \uc5bc\ub9c8\uc778\uac00\uc694? (\uc608: 1kW)",
    "load_resistance": "\ubd80\ud558 \uc800\ud56d\uc740 \uba87 \u03a9\uc778\uac00\uc694? (\uc608: 10\u03a9)",
    "r_load": "\ubd80\ud558 \uc800\ud56d\uc740 \uba87 \u03a9\uc778\uac00\uc694?",
    "output_frequency": "\ucd9c\ub825 \uc8fc\ud30c\uc218\ub294? (\uc608: 60Hz)",
    "grid_voltage": "\uacc4\ud1b5 \uc804\uc555\uc740 \uba87 V\uc778\uac00\uc694? (\uc608: 220V)",
    "voc": "\ud0dc\uc591\uad11 \ud328\ub110 \uac1c\ubc29\uc804\uc555(Voc)\uc740? (\uc608: 40V)",
    "isc": "\ud0dc\uc591\uad11 \ud328\ub110 \ub2e8\ub77d\uc804\ub958(Isc)\ub294? (\uc608: 10A)",
}
